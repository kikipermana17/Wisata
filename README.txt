...
<head>
  ...
  ================================================== -->
    ...
    <!-- bootstrap.min -->
    <link rel="stylesheet" href="{{ asset('/frontend/css/slit-slider.css') }}">
    <!-- bootstrap.min -->
                    ...
                    <div class="col-md-7 col-md-offset-1 wow animated fadeInRight">
                        <div class="welcome-block">
                            ...
                            <div class="message-body">
                                <img src="{{ asset('/frontend/img/member-1.jpg') }}" class="pull-left"
                                    alt="member">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 wow animated fadeInRight">
                        <address class="contact-details">
                            <h3>Contact Us</h3>
                            <p><i class="fa fa-pencil"></i>Phoenix Inc.<span>PO Box 345678</span> <span>Little
                                    Lonsdale
